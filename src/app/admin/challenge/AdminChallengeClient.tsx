...
const SCRIPT_DEFAULTS = {
  ...
  requirements: [
    ...
    'اليوم الثاني: ابدئي التغيير فعليًا — تمارين واستراتيجيات تساعدك على: إيقاف ردّة الفعل، التعامل مع trigger، والخروج من نمط التوتر المتكرر',
    'اليوم الثالث: جلسة تطبيق وأسئلة مباشرة — سنأخذ حالات حقيقية من المشاركات ونطبّق ما تعلّمناه على مواقف واقعية',
  ],
}
